 ...
 <section id="gtco-welcome" class="bg-white section-padding">
            <div class="container">
                <div class="section-content">
                    <div class="row">
                        <div class="col-sm-5 img-bg d-flex shadow align-items-center justify-content-center justify-content-md-end img-2" style="background-image: url({{asset('frontend/img/hero-2.jpg')}});">
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <a href="#" class="thumb-menu">
                                            <img class="img-fluid img-cover" src="{{asset('frontend/img/hero-1.jpg')}}" />
                ...
                <div class="section-content">
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-lg-5 offset-lg-2 col-md-6 align-self-center mt-4 mt-md-0">
                            <img src="{{asset('frontend/img/steak.jpg')}}" alt="" class="img-fluid shadow w-100">
                        </div>
                    </div>
                    <div class="row mt-5">
                        <div class="col-lg-5 col-md-6 align-self-center order-2 order-md-1 mt-4 mt-md-0">
                            <img src="{{asset('frontend/img/salmon-zucchini.jpg')}}" alt="" class="img-fluid shadow w-100">
                        </div>
                        ...
                        <div class="col-lg-4 menu-wrap">
                            ...
                            <div class="menus d-flex align-items-center">
                                <div class="menu-img rounded-circle">
                                    <img class="img-fluid" src="{{asset('frontend/img/breakfast-1.jpg')}}" alt="">
                                </div>
                                <div class="text-wrap">
        ...
        <!-- End of menu Section -->
        <!-- Testimonial Section-->
        <section id="gtco-testimonial" class="overlay bg-fixed section-padding" style="background-image: url({{asset('frontend/img/testi-bg.jpg')}});">
            <div class="container">
                <div class="section-content">
                    <div class="heading-section text-center">
                        <span class="subheading">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="team-card mb-5">
                                <img class="img-fluid" src="{{asset('frontend/img/chef-1.jpg')}}" alt="">
                                <div class="team-desc">
                        ...
                        <div class="col-md-4">
                            <div class="team-card mb-5">
                                <img class="img-fluid" src="{{asset('frontend/img/chef-2.jpg')}}" alt="">
                                <div class="team-desc">
                        ...
                        <div class="col-md-4">
                            <div class="team-card mb-5">
                                <img class="img-fluid" src="{{asset('frontend/img/chef-3.jpg')}}" alt="">
                                <div class="team-desc">
        ...
        <!-- End of Team Section -->
        <!-- Reservation Section -->
        <section id="gtco-reservation" class="bg-fixed bg-white section-padding overlay" style="background-image: url({{asset('frontend/img/reservation-bg.jpg')}});">
            <div class="container">
                <div class="row">
                    <div class="col-lg-5">
